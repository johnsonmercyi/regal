...
<div class="row z-depth-1 borderRound" >
    <form action="" id="viewClassResult">
            ...
            <div class="col s12 m3 center input-field">
                <button type="submit" id="loadClassResults" class="btn btn-default colCode">Load</button>
            </div>
...
<!-- <div class="section display responsive-table z-depth-1 hide" id="scoreTable"> -->
    ...
    <table class="centered z-depth-1 hide" id="resultListTable">
        <thead class="white-text colCode" id="resultTableHead"></thead>
