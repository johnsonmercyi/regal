...
<div class="section">
    ...
    <div class="row z-depth-1 borderRound" >
        <form method="POST" action="" id="enterNurseryScores">
            ...
            <div class="col s12 m2 center input-field">
                <button type="submit" id="loadNurserySubjectStudents" class="btn btn-default {{ $school->themeColor }}">Load</button>
            </div>
...
<!-- <script type="module" src="{{ asset('assets/custom/NurseryScoresManager.js') }}" ></script> -->
