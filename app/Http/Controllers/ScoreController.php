...
class ScoreController extends Controller
{
    ...
    public function index(Request $request, School $school) {
        ...
        return view('scores.index', compact('school', 'allClass', 'subjects', 'acadSession'));
    }
        ...
        if($getStudents){
            ...
            if($subjectStudents != 'All'){
                $allStudents = DB::table('students')->
                                    select('students.id', 'students.firstName', 'students.lastName', 'students.otherName')->
                                    whereIn('students.id', $subjectStudents)->orderBy('students.lastName', 'ASC')->get();
